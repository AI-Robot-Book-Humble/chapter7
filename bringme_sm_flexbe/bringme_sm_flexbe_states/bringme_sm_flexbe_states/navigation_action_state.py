...
"""Navigation Action FlexBE State."""
...
class NavigationActionState(EventState):
    ...
    Userdata
    ># destination  string 目的地の名前 (string型) (Input)
    #> text         string Actionによる移動の結果 (string型) (Output)
    ...
    def on_enter(self, userdata):
        ...
        # userdataにdestinationという情報があるかを確認します
        ...
        goal.command = str(userdata.destination)
